    ...
    <div className="min-h-screen flex flex-col bg-devbeacons-dark overflow-hidden relative">
      ...
      <main className="container flex-1 flex flex-col items-center justify-center text-center px-4 z-10">
        ...
        <Button 
          ...
          className="flex items-center gap-2 text-lg py-6 px-8 bg-white/10 hover:bg-white/15 text-white border border-white/10"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 max-w-4xl">
          <div className="glass-panel p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-devbeacons-primary/20 flex items-center justify-center mb-4">
          ...
          <div className="glass-panel p-6 flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-full bg-devbeacons-success/20 flex items-center justify-center mb-4">
