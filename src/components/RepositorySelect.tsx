...
export function RepositorySelect({ onSelectRepository }: RepositorySelectProps) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[300px] p-0 bg-devbeacons-darker border-sidebar-border">
        <Command className="bg-transparent">
          <CommandInput placeholder="Search repository..." className="border-none focus:ring-0 text-foreground" />
